...
class Administrator extends React.Component {
    ...
    handleDelete() {
        ...
        if (data.days !== "" && parseFloat(data.days) >= 0) {
                    ...
                    <Card>
                        <CardContent>
                            <div className="GenerateReport">
                                <Link to="/adminReport">
                                    <Button variant="contained" id="GenerateReport" color="primary" size="large">Generate
                                        Report of Choices</Button>
                                </Link>
                            </div>
                        </CardContent>
                    </Card>
                    ...
                    <Card variant="outlined">
                        <CardContent>
                            <div className="DeleteChoices">
                                ...
                                <TextField id="NumChoiceDelete" type="number" style={{width: '15%'}}/>
